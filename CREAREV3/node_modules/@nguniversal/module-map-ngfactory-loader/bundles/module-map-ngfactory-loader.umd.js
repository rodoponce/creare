(function (global, factory) {
	...
	(factory((global.nguniversal = global.nguniversal || {}, global.nguniversal.moduleMapNgfactoryLoader = global.nguniversal.moduleMapNgfactoryLoader || {}),global.ng.core));
 ...
 */
var MODULE_MAP = new _angular_core.InjectionToken('MODULE_MAP');
/**
...
var ModuleMapNgFactoryLoader = /** @class */ (function () {
    ...
    function (loadChildrenString) {
        var /** @type {?} */ offlineMode = this.compiler instanceof _angular_core.Compiler;
    ...
    ModuleMapNgFactoryLoader.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: _angular_core.Inject, args: [MODULE_MAP,] },] },
    ]; };
